...
exports.__esModule = true;
 exports.isStarted = exports.stop = exports.start  = exports.init = void 0;
var react_native_1 = require("react-native");
var BDGeolocation = react_native_1.NativeModules.BDGeolocation;
var eventEmitter = new react_native_1.NativeEventEmitter(BDGeolocation);
/**
 * 初始化 SDK
 *
 ...
 */
function init(key) {
    return BDGeolocation.init(react_native_1.Platform.select(key));
}
exports.init = init;
/**
 * 添加定位监听函数
...
function addLocationListener(listener) {
    return eventEmitter.addListener("BDGeolocation", listener);
}
